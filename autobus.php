<?php
  ...
  $result = mysql_query("SELECT * FROM autobus order by idconductor ASC");
?>
<!DOCTYPE html>
<html>
    <head>
                ...
                <td>
                    <div class="row-fluid">
                      <div class="span6">
                          ...
                          Registro de Autobuses</h3>
                      </div>
                      <div class="span6">
                        <div align="right">
            <br><br><br>
              <a href="#nuevo" role="button" class="btn btn-info" data-toggle="modal">
                              <strong><i class="icon-user"></i> Agregar Nuevo Autobus</strong>
              </a>                
...
<form name="form2" method="post" enctype="multipart/form-data" action="insertarConductor.php">
  ...
  <div class="modal-body">
    <div class="row-fluid">
          <div class="span6">
			  ...
			  <input type="date" id="datepicker9" name="Capacidad" value="<?php echo $row['Capacidad']; ?>"><br>
