                ...
                <?php  while ($row = mysql_fetch_array($result)) {
                        ...
                        <tr>
                            ...
                            <td><?php
								...
								$fechahorapartida=$row['fechapartida']." ".['horapartida'];
								echo  $fechahorapartida;?> </td>
                            ...
                            <!--<th>
								<a href="#actualizar<?php echo $row['idservicio']; ?>" role="button" class="btn btn-mini" data-toggle="modal" title="Actualizar gil">
									<i class="icon-edit"></i>
								</a>
							</th>	
				    ...
				    <form name="form2" method="post" enctype="multipart/form-data" action="actualizarProducto.php">
                        ...
                        <div class="modal-body">
                            <div class="row-fluid">
                                <div class="span6">
					                ...
					                <strong>Nombre del Servicio</strong><br>
                                    <input type="text" name="nombreservicio" autocomplete="off" required value="<?php echo $row['nombreservicio']; ?>"><br>
                                    <strong>Costo del Servicio</strong><br>
                                  <input type="text" name="costoservicio" autocomplete="off" required value="<?php echo $row['costoservicio']; ?>"><br>
								</div>
                                <div class="span6">
                                    <center><button type="submit" class="btn btn-primary"><strong><i class="icon-ok"></i> Actualizar Servicio</strong></button></center>
                                </div>
                            </div>
                        </div>
