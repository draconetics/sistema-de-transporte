								...
								<td>
									...
									<tbody>
										...
										<tr>
											...
											<th>
												<a href="#actualizar<?php echo $row['idcliente']; ?>" role="button" class="btn btn-mini" data-toggle="modal" title="Recargar ">
										...
										<div id="actualizar<?php echo $row['idcliente']; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
											<form name="form2" method="post" enctype="multipart/form-data" action="insertarServicio_cliente.php">
												...
												<div class="modal-header">
													...
													<h3 id="myModalLabel">Recargar credito</h3>
												</div>
														...
														<div class="span6">
															...
															<?php
																...
																while($d=mysql_fetch_array($c)){
																	echo '<option value="'.$d['idtarjeta'].'">'.$d['nombretarjeta'].$d['saldo'].'</option>';
																}
															?> 
															</select><br>
															...
															<div class="modal-footer">
																<button class="btn btn-primary" data-dismiss="modal" aria-hidden="true"><strong> Recargar</strong></button>
															</div>
														</div>
													</div>
												</div>
												...
												<div class="modal-body">
													<div class="row-fluid">
														<div class="span6">
															...
															<strong>Apellido del Cliente</strong><br>
															<input type="text" name="apellidocliente" autocomplete="off" disabled=true value="<?php echo $row['apellidocliente']; ?>"><br> 
															   <strong>CI del Cliente</strong><br>
															<input type="text" name="ci" autocomplete="off" disabled=true value="<?php echo $row['ci']; ?>"><br> 
															<strong>Tipo de Cliente</strong><br>
															<input type="text" name="nombretipo" autocomplete="off" disabled=true value="<?php echo $row['nombretipo']; ?>"><br>											
														</div>	
														...
														<div class="span6">
															...
															?>
																...
																<center><button class="btn btn-primary" data-dismiss="modal" aria-hidden="true"><strong> Imprimir</strong></button></center>
